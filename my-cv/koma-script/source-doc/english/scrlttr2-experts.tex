...
% Date of the translated German file: 2014/12/16
...
\Class{scrartcl}. Therefore \Package{scrletter} defines page
style\ChangedAt{v3.15}{\Package{scrletter}} \Pagestyle{letter} instead. The
definition is done using package
\Package{scrlayer-scrpage}\IndexPackage{scrlayer-scrpage}. Hence,
you cannot use the outdated packages \Package{scrpage2}\IndexPackage{scrpage2}
and \Package{scrpage} or package \Package{fancyhdr}\IndexPackage{fancyhdr}
...
\section{Differences in the Handling of \File{lco}-Files in \Package{scrletter}}
