...
\Macro{marginline}.  Darüber hinaus wird in \autoref{cha:scrlayer-notecolumn}
ein Paket vorgestellt, mit dem sich auch Notizspalten mit eigenem
Seitenumbruch realisieren lassen. %
\iffalse% Umbruchkorrektur
Allerdings ist das Paket
\Package{scrlayer-notecolumn}\IndexPackage{scrlayer-notecolumn} eher als eine
Konzeptstudie und weniger als fertiges Paket zu verstehen.%
\fi%
\fi%
