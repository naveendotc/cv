...
\KOMAProvidesFile{scrlttr2.tex}%
                 [$Date: 2014-10-09 08:08:31 +0200 (Thu, 09 Oct 2014) $
...
\item[{\Pagestyle{headings}}] ist der Seitenstil für automatische
  ...
  \autopageref{desc:scrlayer-scrpage.cmd.markleft}), zur Verfügung.
\item[{\Pagestyle{myheadings}}] ist der Seitenstil für manuelle Kolumnentitel
  ...
  \Macro{markleft}\IndexCmd{markleft} zur Verfügung.
...
\Package{scrlayer-scrpage}\IndexPackage{scrlayer-scrpage}\important{\Package{scrlayer-scrpage}}
gilt dies natürlich auch für den Seitenstil
...
\File{lco}-Datei geladen wird. Außerdem können interne Anweisungen
...
%  LocalWords:  Paketoption Satzspiegels
